...
class _AddUsedEquipmentPageState extends State<AddUsedEquipmentPage> {
  ...
  final TextEditingController _inventoryPriceController = TextEditingController();
    ...
    return Column(
      ...
      children: [
        TextFormField(
          ...
          keyboardType: isPhoneNumber || isNumeric ? TextInputType.number : TextInputType.text,
          maxLines: maxLines,
          ...
          validator: (value) {
            ...
            if (isName && !RegExp(r"^[a-zA-Z0-9\s\-\.]+$").hasMatch(value)) return "Only letters, numbers, spaces, hyphens, and periods are allowed";
            ...
            if (isNumeric && double.tryParse(value) == null) return "$label must be a number";
            return null;
          },
        ),
      ],
      ...
      children: [
            ...
            items: _categories.map((String category) {
              return DropdownMenuItem<String>(
                ...
                child: Row(
                  children: [
                    Icon(
                      category == "Other (Custom)" ? Icons.edit : Icons.category_outlined,
        ...
        if (_isCustomCategory) ...[
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.lightbulb_outline, color: Color(0xFF008080), size: 20),
                SizedBox(width: 8),
                Expanded(
                  child: Text(
            ...
            return Container(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                      color: isSelected ? condition['color'] : Colors.grey[300]!,
                  ...
                  child: Row(
                    children: [
                      Icon(
                        condition['icon'],
                        color: isSelected ? condition['color'] : Colors.grey[600],
                        size: 24,
                      ),
                      SizedBox(width: 16),
                      Expanded(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w600,
                                color: isSelected ? condition['color'] : Colors.grey[800],
                              ),
                            ),
                            SizedBox(height: 4),
                            Text(
    ...
    Form(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.build_outlined, color: Color(0xFF008080), size: 28),
              SizedBox(width: 12),
              Text("Equipment Name", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            ],
          ),
          SizedBox(height: 16),
          Container(
    ...
    Form(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.description_outlined, color: Color(0xFF008080), size: 28),
              SizedBox(width: 12),
          ...
          _buildTextField(
            ...
            maxLines: 6,
            helperText: "Include specifications, accessories, usage history, etc.",
          ),
        ],
      ),
    ),
    ...
    Form(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.assessment_outlined, color: Color(0xFF008080), size: 28),
              SizedBox(width: 12),
    ...
    Form(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.attach_money_outlined, color: Color(0xFF008080), size: 28),
              SizedBox(width: 12),
              Text("Pricing & Stock", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            ],
          ),
          SizedBox(height: 16),
          Container(
    ...
    Form(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.category_outlined, color: Color(0xFF008080), size: 28),
              SizedBox(width: 12),
    ...
    Form(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.photo_camera_outlined, color: Color(0xFF008080), size: 28),
              SizedBox(width: 12),
              Text("Equipment Photos", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            ],
          ),
          SizedBox(height: 16),
          Container(
            ...
            children: [
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: Text("Select Photos", style: TextStyle(color: Colors.white)),
          ...
          if (_selectedImages.isEmpty)
            Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(color: Color(0xFF008080), width: 2, style: BorderStyle.solid),
                borderRadius: BorderRadius.circular(12),
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.image_outlined, color: Color(0xFF008080), size: 48),
                  SizedBox(height: 12),
                  Text(
                    "No photos selected",
                    style: TextStyle(
            ...
            Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.photo_library, color: Color(0xFF008080), size: 20),
                    SizedBox(width: 8),
                    Text(
                      ...
                      return Stack(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(
                                color: index == 0 ? Colors.amber : Color(0xFF008080),
                                width: 2,
                              ),
                              borderRadius: BorderRadius.circular(12),
                              boxShadow: [
  ...
  void _nextStep() {
    ...
    if (_formKeys[_currentStep].currentState!.validate()) {
      ...
      if (_currentStep == getStepWidgets().length - 1 && _selectedImages.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
  ...
  Future<void> _submitUsedEquipment() async {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  Text("Adding used equipment...", style: TextStyle(fontSize: 16)),
                ],
              ),
            ),
          );
    ...
    final uri = Uri.parse('http://192.168.43.101:8000/api/product/used-equipment');
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    _currentStep == steps.length - 1 ? 'Add Equipment' : 'Continue',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
